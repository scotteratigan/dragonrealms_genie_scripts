...
Cleaning:
	gosub Send RT "clean %Clean.target" "^You drag the waste bucket close and prepare to clean off the anvil\.$|^You stop working and clean off the anvil's surface, discarding .+ into the .+\.$" "^Clean what\?$|^You glance at the anvil's contents, and realize you should be able to remove them yourself\.$" "^There is nothing to clean off the anvil\!$"
