...
Pushing:
	...
	gosub Send Q "push %Push.command" "^You push.*$|^You quickly find a rhythm with shoveling load after load of coal into the fire\.  Eventually the fuel begins to catch and the fire picks up in intensity\.$|^Sweat dripping from your face, you heap pile after pile of coal atop the fire with your shovel\.  Satisfied, you lean on the shovel and wipe off your brow\.$|^Gripping the shovel tightly, you slam it deep into the pile of fuel.*$|^With wide sweeps of the shovel you scatter fuel evenly across the fire\.  Then, for good measure you shovel out the spent ash into the nearby waste bucket\.$|^Gusts of hot steam billow from the tub as you submerse the scorching hot .+\.$|^Wisps of hot smoke curl up from the tub as you slip the .+ into it\.$|^Using short pumps of the bellows you fan the flames of the fire\.$|^You pump your bellows fiercely over the hot coals\.$|^You force copious amounts of air into the hot coals by pumping the bellows\.$|^You stoke the fire with strong pumps of your bellows\.$|^An explosive blast of steam erupts from your .+ as it hits the cool water of the slack tub\!$|^With grinding complete, the metal now needs protection by pouring oil on it\.$|^Flipping through the .+, you find room in a matching section, and copy in the spell\.  Your .+ crumbles to dust afterward\.$|^Not finding a matching section, you flip to an empty section, and after labeling it, you copy in the spell\.  Your .+ crumbles to dust afterward\.$|^You count out 1000 Dokoras.*$" "^Push what\?$|^That tool does not seem suitable for that task\.$|^You need another .+ to continue crafting.*$|^The grinding wheel is not spinning fast enough to do that and needs to be turned some more\.$|^The grinding wheel needs to be spinning before it can be used to polish and sharpen weapons\.  Perhaps you should try turning it\?$|^Flipping through your .+, you realize there's no more room\.$|^\[If you're trying to add something to your .+, you need to open the .+ first\.\]$|^Realizing that the \w+ is not labelled, you stop, unsure of where to add the spell in\.$|^That does not look like something that can be deeded\.$|^It would be best to wait until you're not poisoned before trying the spinneret again\.$" "WARNING MESSAGES"
