...
Turning:
	...
	gosub Send Q "turn %Turn.command" "^You turn .+ to.*$|^Grabbing the handle you strain to turn the grindstone\.$|^You lay .+ down parallel to the anvil's horn and notice it has become crooked\. Turning it about, you gently tap it back to the correct straightness\.$|^You angle the .+ downward along the anvil's horn with your tongs, and then gently tap it with your hammer\.$|^You hold the .+ steady on the horn of the anvil with your tongs\.  Then you tap it lightly with your hammer to add a curve along the metal's surface\.$" "^A .+ does not have a chapter .+\.$|^This chapter does not have that many pages\.$|^Where do you wish to turn .+ to\?$" "^The book is already turned to.*$"
	pause .01
